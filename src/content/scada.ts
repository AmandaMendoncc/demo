...
export const scada: PageContent = {
  ...
  blocks: [
    ...
    {
      kind: 'box',
      title: 'Real-Time Functionality — SCADA, HMI, MES, IIoT Edge and Gateway',
      items: [
    ...
    },
    {
      kind: 'boxgrid',
      columns: [
        { title: 'Core Functionalities', items: ['OPCUA', 'Drivers', 'SQL', 'Graphics', 'Alarms'] },
        { title: '', items: ['Tags', 'Scripts', 'Dashboards & Reporting', 'HTML5', 'MQTT'] },
        {
          title: 'Platform — GridQ (Action.Net)',
          items: [
